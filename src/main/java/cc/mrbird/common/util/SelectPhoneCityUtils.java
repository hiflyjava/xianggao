 ...
 * @Description:
 */
public class SelectPhoneCityUtils {
    ...
    public static void main(String[] args) {
        PhoneModel phoneModel = SelectPhoneCityUtils.getPhoneModel("17506216829");
        boolean phone = CheckPhone.isChinaUnicomPhoneNum("13975162773");
